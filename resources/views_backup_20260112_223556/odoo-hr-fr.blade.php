...
<head>
    ...
    <title>Services Odoo - Ressources Humaines | Software Makers Limited Company</title>
            ...
            <div class="row">
                <div class="col-lg-10 mx-auto">
                    <div class="text-center mb-5">
                        <h1 class="display-4 fw-bold text-primary mb-3" style="font-size: 3rem; margin-bottom: 2rem;">Ressources Humaines</h1>
                    </div>
                        ...
                        <div class="card-body p-5">
                            <div class="row">
                                <div class="col-lg-8">
                                    ...
                                    <p class="lead mb-4">L'employé est au cœur de la productivité. Nous repensons le module Odoo HR pour qu'il soit plus qu'un système de paie — c'est une plateforme interactive pour gérer tout le cycle de vie de l'employé.</p>
                                    
                                    <h3 class="text-primary mb-3">⚙️ Ce que nous implémentons :</h3>
                                    <ul class="list-unstyled">
                                        <li class="mb-2"><i class="fas fa-check-circle text-success me-2"></i>Gestion automatique des processus de recrutement, contrats, salaires et congés</li>
                                        <li class="mb-2"><i class="fas fa-check-circle text-success me-2"></i>Liaison de la présence et de l'absence avec des systèmes Fingerprint ou Face Recognition</li>
                                        <li class="mb-2"><i class="fas fa-check-circle text-success me-2"></i>Construction d'un portail employé moderne pour soumettre des demandes et suivre les droits</li>
                                        <li class="mb-2"><i class="fas fa-check-circle text-success me-2"></i>Génération automatique de rapports de conformité pour les systèmes de travail saoudiens</li>
                                    </ul>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <div class="d-flex align-items-start">
                                        ...
                                        <div>
                                            <h5>Intégration complète avec les systèmes gouvernementaux (plateformes d'assurance sociale, zakat et revenus)</h5>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <div class="d-flex align-items-start">
                                        ...
                                        <div>
                                            <h5>Conception d'une expérience employé fluide qui stimule la productivité</h5>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <div class="d-flex align-items-start">
                                        ...
                                        <div>
                                            <h5>Configuration de processus Onboarding et Offboarding entièrement automatisés</h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="text-center">
                        <div class="alert alert-primary border-0 shadow-sm mb-4">
                            <h4 class="mb-0" style="font-size: 1.1rem;">Avec Software Makers, le système de ressources humaines d'Odoo devient un système centré sur l'humain, reliant les employés dans un environnement unifié qui renforce l'engagement, soutient l'efficacité et permet aux individus d'atteindre leur meilleure performance.</h4>
                        </div>
