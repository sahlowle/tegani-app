...
<head>
    ...
    <title>Growth Strategy Formulation | Software Makers - SMLC</title>
                ...
                <div class="col-lg-12 text-center" data-aos="fade-up">
                    <div class="hero-content">
                        <h1 class="display-4 fw-bold mb-4" style="color: #ffffff; text-shadow: 2px 2px 4px rgba(0,0,0,0.8);">
                            ...
                            <span style="color: #00d4ff; text-shadow: 0 0 15px rgba(0, 212, 255, 0.6);">Growth Strategy Formulation</span>
                        </h1>
                        <p class="lead mb-4" style="color: #e8f4fd; text-shadow: 1px 1px 2px rgba(0,0,0,0.7); font-size: 1.1rem;">
                            Purpose-built strategic plans that increase market share and unlock sustainable competitiveness.
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center mb-5" data-aos="fade-up">
                    <span class="service-badge">Growth Strategy</span>
                    <h2 class="section-title">Strategic Plans for <span class="text-gradient">Sustainable Growth</span></h2>
                    <p class="section-subtitle">Data-driven blueprints to scale with confidence</p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-lg-10 mx-auto" data-aos="fade-up">
                    ...
                    <div class="service-intro mb-5">
                        ...
                        <p class="lead">
                            We help ambitious organizations architect long-term growth strategies rooted in deep market intelligence,
                            competitive insights, and clear customer needs. Every plan blends realistic assessment, bold vision,
                            and measurable execution pathways.
                        </p>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-4">
                                <div class="feature-card">
                                    ...
                                    <h5>Evidence-Based Expansion Plans</h5>
                                    <p>We translate market and sector data into clear prioritization and growth scenarios.</p>
                                </div>
                            </div>
                            <div class="col-md-6 mb-4">
                                <div class="feature-card">
                                    ...
                                    <h5>Growth Roadmaps</h5>
                                    <p>Concrete initiatives that cover new services, segments, and geographic plays.</p>
                                </div>
                            </div>
                            <div class="col-md-6 mb-4">
                                <div class="feature-card">
                                    ...
                                    <h5>Risk & Scenario Planning</h5>
                                    <p>Contingency planning that protects investments and keeps momentum steady.</p>
                                </div>
                            </div>
                            <div class="col-md-6 mb-4">
                                <div class="feature-card">
                                    ...
                                    <h5>Aligned Objectives</h5>
                                    <p>Linking financial targets, operational KPIs, and leadership vision around one narrative.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-12 mb-3">
                                <div class="card border-primary">
                                    <div class="card-body">
                                        <h5 class="card-title"><i class="fas fa-check-circle text-primary me-2"></i>Growth Blueprint for a Tech Scale-Up</h5>
                                        <p class="card-text">Regional expansion roadmap across the GCC with partner plays.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 mb-3">
                                <div class="card border-primary">
                                    <div class="card-body">
                                        <h5 class="card-title"><i class="fas fa-check-circle text-primary me-2"></i>Market Share Acceleration Plan</h5>
                                        <p class="card-text">Omnichannel growth plan for a financial services provider.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 mb-3">
                                <div class="card border-primary">
                                    <div class="card-body">
                                        <h5 class="card-title"><i class="fas fa-check-circle text-primary me-2"></i>Phased Growth Model</h5>
                                        <p class="card-text">Launch playbook for a retail start-up entering new cities.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="alert alert-light border-primary text-center p-4">
                        ...
                        <p class="h5 mb-0">We turn ambition into measurable growth using strategies powered by data, creativity, and disciplined execution.</p>
                    </div>

                    <!-- CTA Section -->
                    <div class="text-center mt-5">
                        <a href="index-en.html#contact" class="btn btn-primary btn-lg">
                            <i class="fas fa-phone me-2"></i>Talk to Our Growth Experts
                        </a>
                    </div>
                </div>
            </div>
