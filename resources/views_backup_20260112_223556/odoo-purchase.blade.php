...
<head>
    ...
    <title>خدمات Odoo - إدارة المشتريات (Purchase) | شركة صناع البرمجيات المحدودة</title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto align-items-center" style="gap: 0.15rem; flex-wrap: nowrap;">
                    ...
                    <li class="nav-item dropdown mega-menu">
                        ...
                        <ul class="dropdown-menu dropdown-menu-mega shadow-lg" style="border: none; border-radius: 12px; padding: 1rem; min-width: 280px; max-width: 100%; margin-top: 0.5rem;">
                            ...
                            <li><a class="dropdown-item px-3 py-2 rounded active" href="{{ route('odoo-purchase') }}" style="transition: all 0.2s ease; margin-bottom: 0.25rem;">
                ...
                <div class="d-flex align-items-center ms-2 gap-1 flex-wrap" style="flex-shrink: 0;">
                    <a href="{{ route('odoo-purchase') }}" class="btn btn-outline-light btn-sm d-flex align-items-center gap-2" style="border: 2px solid rgba(255,255,255,0.8); padding: 0.45rem 0.65rem; border-radius: 10px; transition: all 0.3s ease; font-weight: 600; white-space: nowrap; font-size: 0.9rem; background: rgba(0,0,0,0.2);" title="Arabic">
                        <img src="https://flagcdn.com/w20/sa.png" alt="علم السعودية" width="20" height="15" style="border-radius: 3px;">
                        <span>AR</span>
                    </a>
                    <a href="{{ route('odoo-purchase-en') }}" class="btn btn-outline-light btn-sm d-flex alignments-center gap-2" style="border: 2px solid rgba(255,255,255,0.8); padding: 0.45rem 0.65rem; border-radius: 10px; transition: all 0.3s ease; font-weight: 600; white-space: nowrap; font-size: 0.9rem;" title="English">
                        <img src="https://flagcdn.com/w20/gb.png" alt="British Flag" width="20" height="15" style="border-radius: 3px;">
                        <span>EN</span>
                    </a>
                    <a href="{{ route('odoo-purchase-fr') }}" class="btn btn-outline-light btn-sm d-flex align-items-center gap-2" style="border: 2px solid rgba(255,255,255,0.8); padding: 0.45rem 0.65rem; border-radius: 10px; transition: all 0.3s ease; font-weight: 600; white-space: nowrap; font-size: 0.9rem;" title="Français">
            ...
            <div class="row">
                <div class="col-lg-10 mx-auto">
                    <div class="text-center mb-5">
                        <h1 class="display-4 fw-bold text-primary mb-3" style="font-size: 3rem; margin-bottom: 2rem;">إدارة المشتريات</h1>
                    </div>
                        ...
                        <div class="card-body p-5">
                            <div class="row">
                                <div class="col-lg-8">
                                    ...
                                    <p class="lead mb-4">إدارة المشتريات ليست إجراءات روتينية، بل منظومة فعالة لتحقيق وفورات مالية وتحسين سلسلة التوريد. نحوّل وحدة Odoo Purchase إلى مركز تحكّم رقمي متكامل.</p>
                                    
                                    <h3 class="text-primary mb-3">⚙️ ما الذي نُنفّذه:</h3>
                                    <ul class="list-unstyled">
                                        <li class="mb-2"><i class="fas fa-check-circle text-success me-2"></i>إنشاء مسارات موافقات متعددة المستويات للطلبات والعقود</li>
                                        <li class="mb-2"><i class="fas fa-check-circle text-success me-2"></i>أتمتة أوامر الشراء وربطها بمستويات المخزون والتوريد</li>
                                        <li class="mb-2"><i class="fas fa-check-circle text-success me-2"></i>مراقبة أداء الموردين وتحليل الأسعار بشكل لحظي</li>
                                        <li class="mb-2"><i class="fas fa-check-circle text-success me-2"></i>تقارير استراتيجية لتوقع الاحتياجات المستقبلية وتقليل الهدر</li>
                                    </ul>
                                </div>
                                <div class="col-lg-4 text-center">
                                    <i class="fas fa-shopping-cart text-primary" style="font-size: 8rem; opacity: 0.3;"></i>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <div class="d-flex align-items-start">
                                        ...
                                        <div>
                                            <h5>دمج المشتريات مع الأنظمة المالية والمخزون لتوفير رؤية موحدة</h5>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <div class="d-flex align-items-start">
                                        ...
                                        <div>
                                            <h5>خبرة في تنفيذ حلول eProcurement للجهات الحكومية والمؤسسات الكبرى</h5>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <div class="d-flex align-items-start">
                                        ...
                                        <div>
                                            <h5>بناء أنظمة ذكاء توريد تقلل الكلفة وتضمن الاستمرارية</h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="text-center">
                        <div class="alert alert-primary border-0 shadow-sm mb-4">
                            <h4 class="mb-0" style="font-size: 1.1rem;">مع شركة صُنّاع البرمجيات، تصبح المشتريات قوة استراتيجية تقود النمو، أكثر كفاءة، أصدق شفافية، وأذكى في إدارة التكاليف. نمنحك التحكم الكامل في سلسلة التوريد، ونحوّل بيانات الشراء إلى قرارات تصنع الفرق.</h4>
                        </div>
                ...
                <div class="col-12">
                    <div class="d-flex flex-column align-items-center">
                        ...
                        <div class="mt-3 d-inline-flex align-items-center gap-2">
                            <a href="{{ route('odoo-purchase') }}" class="d-inline-flex align-items-center justify-content-center rounded-circle" style="width: 32px; height: 32px; border: 1px solid rgba(0,0,0,0.15); overflow: hidden; background: rgba(0,0,0,0.02);">
                                <img src="https://flagcdn.com/w20/sa.png" alt="AR" width="20" height="15" style="display:block;">
                            </a>
                            <a href="{{ route('odoo-purchase-en') }}" class="d-inline-flex align-items-center justify-content-center rounded-circle" style="width: 32px; height: 32px; border: 1px solid rgba(0,0,0,0.15); overflow: hidden; background: rgba(0,0,0,0.02);">
                                <img src="https://flagcdn.com/w20/gb.png" alt="EN" width="20" height="15" style="display:block;">
                            </a>
                            <a href="{{ route('odoo-purchase-fr') }}" class="d-inline-flex align-items-center justify-content-center rounded-circle" style="width: 32px; height: 32px; border: 1px solid rgba(0,0,0,0.15); overflow: hidden; background: rgba(0,0,0,0.02);">
