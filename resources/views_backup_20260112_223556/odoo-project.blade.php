...
<head>
    ...
    <title>خدمات Odoo - إدارة المشاريع (Project) | شركة صناع البرمجيات المحدودة</title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto align-items-center" style="gap: 0.15rem; flex-wrap: nowrap;">
                    ...
                    <li class="nav-item dropdown mega-menu">
                        ...
                        <ul class="dropdown-menu dropdown-menu-mega shadow-lg" style="border: none; border-radius: 12px; padding: 1rem; min-width: 280px; max-width: 100%; margin-top: 0.5rem;">
                            ...
                            <li><a class="dropdown-item px-3 py-2 rounded active" href="{{ route('odoo-project') }}" style="transition: all 0.2s ease; margin-bottom: 0.25rem;">
                                <i class="fas fa-project-diagram ms-2 text-primary"></i>
                                Odoo ERP - المشاريع
                            </a></li>
                            ...
                            <li><a class="dropdown-item px-3 py-2 rounded" href="{{ route('odoo-crm') }}" style="transition: all 0.2s ease; margin-bottom: 0.25rem;">
                ...
                <div class="d-flex align-items-center ms-2 gap-1 flex-wrap" style="flex-shrink: 0;">
                    <a href="{{ route('odoo-project') }}" class="btn btn-outline-light btn-sm d-flex align-items-center gap-2" style="border: 2px solid rgba(255,255,255,0.8); padding: 0.45rem 0.65rem; border-radius: 10px; transition: all 0.3s ease; font-weight: 600; white-space: nowrap; font-size: 0.9rem; background: rgba(0,0,0,0.2);" title="Arabic">
                        <img src="https://flagcdn.com/w20/sa.png" alt="علم السعودية" width="20" height="15" style="border-radius: 3px;">
                        <span>AR</span>
                    </a>
                    <a href="{{ route('odoo-project-en') }}" class="btn btn-outline-light btn-sm d-flex alignments-center gap-2" style="border: 2px solid rgba(255,255,255,0.8); padding: 0.45rem 0.65rem; border-radius: 10px; transition: all 0.3s ease; font-weight: 600; white-space: nowrap; font-size: 0.9rem;" title="English">
                        <img src="https://flagcdn.com/w20/gb.png" alt="British Flag" width="20" height="15" style="border-radius: 3px;">
                        <span>EN</span>
                    </a>
                    <a href="{{ route('odoo-project-fr') }}" class="btn btn-outline-light btn-sm d-flex align-items-center gap-2" style="border: 2px solid rgba(255,255,255,0.8); padding: 0.45rem 0.65rem; border-radius: 10px; transition: all 0.3s ease; font-weight: 600; white-space: nowrap; font-size: 0.9rem;" title="Français">
            ...
            <div class="row">
                <div class="col-lg-10 mx-auto">
                    <div class="text-center mb-5">
                        <h1 class="display-4 fw-bold text-primary mb-3" style="font-size: 3rem; margin-bottom: 2rem;">إدارة المشاريع</h1>
                    </div>
                        ...
                        <div class="card-body p-5">
                            <div class="row">
                                <div class="col-lg-8">
                                    ...
                                    <p class="lead mb-4">إدارة المشاريع ليست مجرد تخطيط مهام ومتابعة جداول زمنية — بل هي فن إدارة القيمة. في شركة صُنّاع البرمجيات، نقوم ببناء بيئة رقمية داخل Odoo تُترجم الرؤية الاستراتيجية إلى نتائج ملموسة عبر تكامل المهام، الموارد، والجداول الزمنية في منصة واحدة ذكية.</p>
                                    
                                    <h3 class="text-primary mb-3">⚙️ كيف نُنفّذها باحترافية عالية:</h3>
                                    <ul class="list-unstyled">
                                        <li class="mb-2"><i class="fas fa-check-circle text-success me-2"></i>نبدأ بتحليل دورة حياة المشروع كاملة (Project Lifecycle Analysis) لضمان مواءمة النظام مع طريقة عمل العميل</li>
                                        <li class="mb-2"><i class="fas fa-check-circle text-success me-2"></i>نصمّم مخططات المهام (Tasks Flow) بأسلوب بصري تفاعلي يسهل على الفريق تتبع الأداء في الوقت الفعلي</li>
                                        <li class="mb-2"><i class="fas fa-check-circle text-success me-2"></i>ندمج نظام المشاريع في Odoo مع وحدات الموارد البشرية والمحاسبة لتكون المؤسسة قادرة على إدارة التكلفة والجهد بدقة</li>
                                        <li class="mb-2"><i class="fas fa-check-circle text-success me-2"></i>نضيف طبقات تحليل متقدمة (KPIs Dashboard) لتقارير القيادة والإدارة العليا</li>
                                        <li class="mb-2"><i class="fas fa-check-circle text-success me-2"></i>نُنفّذ التدريب والدعم الفني بنفس الفريق الذي طوّر النظام لضمان الاستمرارية والدقة</li>
                                    </ul>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <div class="d-flex align-items-start">
                                        ...
                                        <div>
                                            <h5>تطبيق معايير PMI وPRINCE2 داخل Odoo بشكل واقعي متكامل</h5>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <div class="d-flex align-items-start">
                                        ...
                                        <div>
                                            <h5>تحويل إدارة المشاريع من عمل روتيني إلى منظومة أداء ذكية مؤتمتة بالكامل</h5>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <div class="d-flex align-items-start">
                                        ...
                                        <div>
                                            <h5>خبرة مثبتة في إدارة مشاريع كبرى لجهات حكومية وتجارية بدقة تتجاوز 99% في الالتزام الزمني</h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="text-center">
                        <div class="alert alert-primary border-0 shadow-sm mb-4">
                            <h4 class="mb-0" style="font-size: 1.1rem;">مع شركة صُنّاع البرمجيات، يصبح أودوو لإدارة المشاريع بيئة متكاملة تنبض بالكفاءة والدقة وسرعة الاستجابة، مما يمكّن فرقك من تنفيذ المشاريع بثقة واحترافية عالية.</h4>
                        </div>
                ...
                <div class="col-12">
                    <div class="d-flex flex-column align-items-center">
                        ...
                        <div class="mt-3 d-inline-flex align-items-center gap-2">
                            <a href="{{ route('odoo-project') }}" class="d-inline-flex align-items-center justify-content-center rounded-circle" style="width: 32px; height: 32px; border: 1px solid rgba(0,0,0,0.15); overflow: hidden; background: rgba(0,0,0,0.02);">
                                <img src="https://flagcdn.com/w20/sa.png" alt="AR" width="20" height="15" style="display:block;">
                            </a>
                            <a href="{{ route('odoo-project-en') }}" class="d-inline-flex align-items-center justify-content-center rounded-circle" style="width: 32px; height: 32px; border: 1px solid rgba(0,0,0,0.15); overflow: hidden; background: rgba(0,0,0,0.02);">
                                <img src="https://flagcdn.com/w20/gb.png" alt="EN" width="20" height="15" style="display:block;">
                            </a>
                            <a href="{{ route('odoo-project-fr') }}" class="d-inline-flex align-items-center justify-content-center rounded-circle" style="width: 32px; height: 32px; border: 1px solid rgba(0,0,0,0.15); overflow: hidden; background: rgba(0,0,0,0.02);">
