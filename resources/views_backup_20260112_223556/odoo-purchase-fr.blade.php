...
<head>
    ...
    <title>Services Odoo - Gestion des Achats | Software Makers Limited Company</title>
            ...
            <div class="row">
                <div class="col-lg-10 mx-auto">
                    <div class="text-center mb-5">
                        <h1 class="display-4 fw-bold text-primary mb-3" style="font-size: 3rem; margin-bottom: 2rem;">Gestion des Achats</h1>
                    </div>
                        ...
                        <div class="card-body p-5">
                            <div class="row">
                                <div class="col-lg-8">
                                    ...
                                    <p class="lead mb-4">La gestion des achats n'est pas des procédures routinières, mais un système efficace pour réaliser des économies financières et améliorer la chaîne d'approvisionnement. Nous transformons Odoo Purchase en un centre de contrôle numérique intégré.</p>
                                    
                                    <h3 class="text-primary mb-3">⚙️ Ce que nous implémentons :</h3>
                                    <ul class="list-unstyled">
                                        <li class="mb-2"><i class="fas fa-check-circle text-success me-2"></i>Création de flux d'approbation multi-niveaux pour les commandes et contrats</li>
                                        <li class="mb-2"><i class="fas fa-check-circle text-success me-2"></i>Automatisation des commandes d'achat et liaison avec les niveaux d'inventaire et d'approvisionnement</li>
                                        <li class="mb-2"><i class="fas fa-check-circle text-success me-2"></i>Surveillance de la performance des fournisseurs et analyse des prix en temps réel</li>
                                        <li class="mb-2"><i class="fas fa-check-circle text-success me-2"></i>Rapports stratégiques pour prédire les besoins futurs et réduire le gaspillage</li>
                                    </ul>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <div class="d-flex align-items-start">
                                        ...
                                        <div>
                                            <h5>Intégration des achats avec les systèmes financiers et d'inventaire pour fournir une vue unifiée</h5>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <div class="d-flex align-items-start">
                                        ...
                                        <div>
                                            <h5>Expérience dans l'implémentation de solutions eProcurement pour les entités gouvernementales et grandes institutions</h5>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <div class="d-flex align-items-start">
                                        ...
                                        <div>
                                            <h5>Construction de systèmes d'intelligence d'approvisionnement qui réduisent les coûts et assurent la continuité</h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="text-center">
                        <div class="alert alert-primary border-0 shadow-sm mb-4">
                            <h4 class="mb-0" style="font-size: 1.1rem;">Avec Software Makers, les achats deviennent une force stratégique qui stimule la croissance, plus efficace, plus transparente et plus intelligente dans la gestion des coûts. Nous vous donnons un contrôle total sur la chaîne d'approvisionnement et transformons les données d'achat en décisions qui font la différence.</h4>
                        </div>
