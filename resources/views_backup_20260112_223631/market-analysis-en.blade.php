...
<head>
    ...
    <title>Market & Investment Opportunities Analysis | Software Makers - SMLC</title>
                ...
                <div class="col-lg-12 text-center" data-aos="fade-up">
                    <div class="hero-content">
                        <h1 class="display-4 fw-bold mb-4" style="color: #ffffff; text-shadow: 2px 2px 4px rgba(0,0,0,0.8);">
                            ...
                            <span style="color: #00d4ff; text-shadow: 0 0 15px rgba(0, 212, 255, 0.6);">Market & Investment Opportunities Analysis</span>
                        </h1>
                        <p class="lead mb-4" style="color: #e8f4fd; text-shadow: 1px 1px 2px rgba(0,0,0,0.7); font-size: 1.1rem;">
                            Studying target markets and analyzing trends and challenges to select the best opportunities.
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center mb-5" data-aos="fade-up">
                    <span class="service-badge">Market Analysis</span>
                    <h2 class="section-title">Comprehensive <span class="text-gradient">Market Analysis</span></h2>
                    <p class="section-subtitle">Data-driven insights to unlock hidden growth opportunities</p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-lg-10 mx-auto" data-aos="fade-up">
                    ...
                    <div class="service-intro mb-5">
                        ...
                        <p class="lead">
                            We conduct advanced market and competitive studies using data analysis tools and market intelligence to identify the best investment opportunities.
                            We focus on analyzing future trends, customer behavior, and demand indicators.
                        </p>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-4">
                                <div class="feature-card">
                                    ...
                                    <h5>Detailed Sector Analysis</h5>
                                    <p>Of target sectors and influencing economic factors</p>
                                </div>
                            </div>
                            <div class="col-md-6 mb-4">
                                <div class="feature-card">
                                    ...
                                    <h5>Market Size Study</h5>
                                    <p>Expected growth rates and potential risks</p>
                                </div>
                            </div>
                            <div class="col-md-6 mb-4">
                                <div class="feature-card">
                                    ...
                                    <h5>Investment Gap Identification</h5>
                                    <p>And high-return opportunities</p>
                                </div>
                            </div>
                            <div class="col-md-6 mb-4">
                                <div class="feature-card">
                                    ...
                                    <p>That help make decisions based on accurate data</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-12 mb-3">
                                <div class="card border-primary">
                                    <div class="card-body">
                                        <h5 class="card-title"><i class="fas fa-check-circle text-primary me-2"></i>Digital Health Services Market Study</h5>
                                        <p class="card-text">In Saudi Arabia and the GCC</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 mb-3">
                                <div class="card border-primary">
                                    <div class="card-body">
                                        <h5 class="card-title"><i class="fas fa-check-circle text-primary me-2"></i>Expansion Feasibility Analysis</h5>
                                        <p class="card-text">In North African markets for an industrial product</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 mb-3">
                                <div class="card border-primary">
                                    <div class="card-body">
                                        <h5 class="card-title"><i class="fas fa-check-circle text-primary me-2"></i>Investment Opportunity Identification</h5>
                                        <p class="card-text">In the renewable energy sector</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="alert alert-light border-primary text-center p-4">
                        ...
                        <p class="h5 mb-0">We uncover hidden growth opportunities within data, enabling smarter investment decisions.</p>
                    </div>

                    <!-- CTA Section -->
                    <div class="text-center mt-5">
                        <a href="index-en.html#contact" class="btn btn-primary btn-lg">
                            <i class="fas fa-phone me-2"></i>Talk to Our Market Analysis Experts
                        </a>
                    </div>
                </div>
            </div>
                ...
                <div class="col-12">
                    <div class="d-flex flex-column align-items-center">
                        ...
                        <div class="mt-3 d-inline-flex align-items-center gap-2">
                            <a href="{{ route('market-analysis') }}" class="d-inline-flex align-items-center justify-content-center rounded-circle" style="width: 32px; height: 32px; border: 1px solid rgba(0,0,0,0.15); overflow: hidden; background: rgba(0,0,0,0.02);">
                                <img src="https://flagcdn.com/w20/sa.png" alt="AR" width="20" height="15" style="display:block;">
                            </a>
                            <a href="{{ route('market-analysis-en') }}" class="d-inline-flex align-items-center justify-content-center rounded-circle" style="width: 32px; height: 32px; border: 1px solid rgba(0,0,0,0.15); overflow: hidden; background: rgba(0,0,0,0.02);">
                                <img src="https://flagcdn.com/w20/gb.png" alt="EN" width="20" height="15" style="display:block;">
                            </a>
                            <a href="{{ route('market-analysis-fr') }}" class="d-inline-flex align-items-center justify-content-center rounded-circle" style="width: 32px; height: 32px; border: 1px solid rgba(0,0,0,0.15); overflow: hidden; background: rgba(0,0,0,0.02);">
