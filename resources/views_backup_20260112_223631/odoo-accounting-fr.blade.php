...
<head>
    ...
    <title>Services Odoo - Comptabilité et Finance | Software Makers Limited Company</title>
            ...
            <div class="row">
                <div class="col-lg-10 mx-auto">
                    <div class="text-center mb-5">
                        <h1 class="display-4 fw-bold text-primary mb-3" style="font-size: 3rem; margin-bottom: 2rem;">Comptabilité et Finance</h1>
                    </div>
                        ...
                        <div class="card-body p-5">
                            <div class="row">
                                <div class="col-lg-8">
                                    ...
                                    <p class="lead mb-4">Nous considérons le module Odoo Accounting comme le nerf financier de l'organisation. Nous le concevons pour vous donner une précision numérique instantanée et une vision financière stratégique moment par moment.</p>
                                    
                                    <h3 class="text-primary mb-3">⚙️ Ce que nous implémentons :</h3>
                                    <ul class="list-unstyled">
                                        <li class="mb-2"><i class="fas fa-check-circle text-success me-2"></i>Configuration d'un plan comptable intégré conforme aux normes internationales IFRS</li>
                                        <li class="mb-2"><i class="fas fa-check-circle text-success me-2"></i>Liaison complète entre la comptabilité, les ventes, les achats et les salaires</li>
                                        <li class="mb-2"><i class="fas fa-check-circle text-success me-2"></i>Automatisation des écritures quotidiennes et de la clôture financière mensuelle</li>
                                        <li class="mb-2"><i class="fas fa-check-circle text-success me-2"></i>Construction de tableaux de bord financiers analytiques (Dashboards) montrant les revenus, les dépenses et la liquidité</li>
                                    </ul>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <div class="d-flex align-items-start">
                                        ...
                                        <div>
                                            <h5>Nous intégrons les solutions comptables avec les systèmes ZATCA pour émettre des factures électroniques approuvées en Arabie Saoudite</h5>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <div class="d-flex align-items-start">
                                        ...
                                        <div>
                                            <h5>Expérience dans la configuration de rapports financiers exécutifs pour les entités réglementaires et gouvernementales</h5>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <div class="d-flex align-items-start">
                                        ...
                                        <div>
                                            <h5>Efficacité élevée dans la migration des systèmes traditionnels vers Odoo sans interruption des opérations</h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="text-center">
                        <div class="alert alert-primary border-0 shadow-sm mb-4">
                            <h4 class="mb-0" style="font-size: 1.1rem;">Avec Software Makers, la finance devient un langage de clarté, chaque chiffre à sa place, chaque action conforme, et chaque décision prête pour l'avenir.</h4>
                        </div>
                ...
                <div class="col-12">
                    <div class="d-flex flex-column align-items-center">
                        ...
                        <div class="mt-3 d-inline-flex align-items-center gap-2">
                            <a href="{{ route('odoo-accounting') }}" class="d-inline-flex align-items-center justify-content-center rounded-circle" style="width: 32px; height: 32px; border: 1px solid rgba(0,0,0,0.15); overflow: hidden; background: rgba(0,0,0,0.02);">
                                <img src="https://flagcdn.com/w20/sa.png" alt="AR" width="20" height="15" style="display:block;">
                            </a>
                            <a href="{{ route('odoo-accounting-en') }}" class="d-inline-flex align-items-center justify-content-center rounded-circle" style="width: 32px; height: 32px; border: 1px solid rgba(0,0,0,0.15); overflow: hidden; background: rgba(0,0,0,0.02);">
                                <img src="https://flagcdn.com/w20/gb.png" alt="EN" width="20" height="15" style="display:block;">
                            </a>
                            <a href="{{ route('odoo-accounting-fr') }}" class="d-inline-flex align-items-center justify-content-center rounded-circle" style="width: 32px; height: 32px; border: 1px solid rgba(0,0,0,0.15); overflow: hidden; background: rgba(0,0,0,0.02);">
