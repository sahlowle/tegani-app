...
<head>
    ...
    <title>Odoo Services - Purchase Management | Software Makers Limited Company</title>
            ...
            <div class="row">
                <div class="col-lg-10 mx-auto">
                    <div class="text-center mb-5">
                        <h1 class="display-4 fw-bold text-primary mb-3" style="font-size: 3rem; margin-bottom: 2rem;">Purchase Management</h1>
                    </div>
                        ...
                        <div class="card-body p-5">
                            <div class="row">
                                <div class="col-lg-8">
                                    ...
                                    <p class="lead mb-4">Purchase management is not routine procedures, but an effective system to achieve financial savings and improve the supply chain. We transform Odoo Purchase into an integrated digital control center.</p>
                                    
                                    <h3 class="text-primary mb-3">⚙️ What We Implement:</h3>
                                    <ul class="list-unstyled">
                                        <li class="mb-2"><i class="fas fa-check-circle text-success me-2"></i>Creating multi-level approval workflows for orders and contracts</li>
                                        <li class="mb-2"><i class="fas fa-check-circle text-success me-2"></i>Automating purchase orders and linking them to inventory and supply levels</li>
                                        <li class="mb-2"><i class="fas fa-check-circle text-success me-2"></i>Monitoring supplier performance and analyzing prices in real-time</li>
                                        <li class="mb-2"><i class="fas fa-check-circle text-success me-2"></i>Strategic reports to predict future needs and reduce waste</li>
                                    </ul>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <div class="d-flex align-items-start">
                                        ...
                                        <div>
                                            <h5>Integrating purchases with financial and inventory systems to provide a unified view</h5>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <div class="d-flex align-items-start">
                                        ...
                                        <div>
                                            <h5>Experience in implementing eProcurement solutions for government entities and large institutions</h5>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <div class="d-flex align-items-start">
                                        ...
                                        <div>
                                            <h5>Building supply intelligence systems that reduce costs and ensure continuity</h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="text-center">
                        <div class="alert alert-primary border-0 shadow-sm mb-4">
                            <h4 class="mb-0" style="font-size: 1.1rem;">With Software Makers, purchasing becomes a strategic force that drives growth, more efficient, more transparent, and smarter in cost management. We give you complete control over the supply chain, and transform purchase data into decisions that make a difference.</h4>
                        </div>
