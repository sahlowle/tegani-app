...
<head>
    ...
    <title>Connexion - Systèmes Biométriques | Software Makers Company</title>
    ...
    <style>
        * {
        ...
        /* Masquer la scrollbar dans body */
        ...
        /* Arrière-plan des motifs biométriques */
        body::before {
            content: '';
            position: absolute;
            top: 0;
        ...
        /* Masquer la scrollbar dans container */
        ...
        /* Lignes de balayage biométrique */
        .scan-lines {
            position: absolute;
            top: 0;
            left: 0;
        ...
        /* Boutons d'options biométriques */
        .biometric-btn {
            background: rgba(255, 255, 255, 0.05);
            border: 2px solid rgba(0, 212, 255, 0.3);
            border-radius: 12px;
